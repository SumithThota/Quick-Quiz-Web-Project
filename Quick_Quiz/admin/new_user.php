...
<div class="form-group">
<label class="col-sm-3 control-label" for="user_username">Email</label>
<div class="col-sm-6">
<input placeholder="Email" class="form-control" required="required" maxlength="30" size="50" type="text"name="regno" id="user_username" />
<div class="help-block with-errors"></div>
</div>
</div>
<div class="form-group">
